...
unipaper.controller('galleryController', function($scope, $rootScope, contentful, utilityFactory, environmentVariables, $stateParams, $state) {
  ...
  var fillMetaTags = function() {
    $rootScope.metaTags = {
      title: $scope.gallery.title + " | The University Paper",
