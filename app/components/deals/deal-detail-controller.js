...
unipaper.controller('dealDetailController', function($scope, contentful, environmentVariables, $rootScope, utilityFactory, $stateParams) {
  ...
  var fillMetaTags = function() {
    $rootScope.metaTags = {
      title: $scope.dealContent.headline + " | The University Paper",
