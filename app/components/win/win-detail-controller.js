...
unipaper.controller('winDetailController', function($scope, contentful, environmentVariables, $rootScope, utilityFactory, $stateParams, $http, CgMailChimpService) {
  ...
  var fillMetaTags = function() {
    $rootScope.metaTags = {
      title: $scope.winContent.headline + " | The University Paper",
