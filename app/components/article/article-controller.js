...
unipaper.controller('articleController', function($scope, contentful, environmentVariables, $rootScope, $stateParams, utilityFactory, $state, $window) {
  ...
  var fillArticleContent = function(articleRaw) {
    $scope.article = {
      ...
      imgDescription: articleRaw.fields.articleImage.fields.description,
      ...
      slug: articleRaw.fields !== undefined && articleRaw.fields.urlSlug !== undefined && articleRaw.fields.urlSlug !== '' ? articleRaw.fields.urlSlug : articleRaw.sys.id,
  ...
  var fillMetaTags = function() {
    $rootScope.metaTags = {
      title: $scope.article.title + " | The University Paper",
