...
unipaper.controller('listicleController', function($scope, $rootScope, contentful, utilityFactory, $stateParams, environmentVariables, $state) {
  ...
  var fillMetaTags = function() {
    $rootScope.metaTags = {
      title: $scope.listicle.title + " | The University Paper",
